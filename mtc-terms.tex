...
\newglossaryentry{partnumber event}
{
  type=mtc,
  category=model,
  name=\deprecated{PART\_NUMBER},
  elementname=\deprecated{\cfont{PartNumber}},
...
\longnewglossaryentry{mtconnect device}
{
...
\longnewglossaryentry{mtconnect interface}
{
...
\longnewglossaryentry{http message}
{
  name={HTTP Message}
}
{
...
\newglossaryentry{rateofpressurization sample}
{
  type=mtc,
  category=model,
  name={RATE\_OF\_PRESSURIZATION},
  elementname=\cfont{RateOfPressurization},
  kind={sample,type},
  description={The change of pressure per unit time.},
  units=\cfont{\gls{pascalpersecond}}
}

\newglossaryentry{pascalpersecond}
{
  type=mtc,
  category=model,
  name={PASCAL/SECOND},
...
\newglossaryentry{pascalperminute}
{
  type=mtc,
  category=model,
  name={PASCAL/MINUTE},
...
\newglossaryentry{millimetermercury}
{
  type=mtc,
  category=model,
...
\newglossaryentry{sensorattachment event}
{
  type=mtc,
  category=model,
  name={SENSOR\_ATTACHMENT},
  elementname=\cfont{SensorAttachment},
  kind={event,type},
  description={A \glselementname{sensorattachment event} is an \gls{event} defining an \gls{attachment} between a sensor and an entity.}
}


\newglossaryentry{sensorid key}
{
  type=mtc,
  category=model,
  name={SENSOR\_ID},
...
\newglossaryentry{keytype}
{
  type=mtc,
  category=model,
  name={keyType},
  description={The \cfont{DataItem} \cfont{type} that defines the meaning of the \cfont{key term}.},
  kind={attribute}
}

\newglossaryentry{gauge subtype}
{
  type=mtc,
  category=model,
  name={GAUGE},
...
\newglossaryentry{adapter component}
{
  type=mtc,
  category=model,
  name={Adapter},
...
\newglossaryentry{deviceadded event}
{
  type=mtc,
  category=model,
  name={DEVICE\_ADDED},
  elementname=\cfont{DeviceAdded},
  kind={event,type},
  description={\glselementname{deviceadded event} is an \gls{event} that provides the \gls{uuid term} of new device added to an \gls{mtconnect agent}.},
  facet={\gls{string}}
}

\newglossaryentry{deviceremoved event}
{
  type=mtc,
  category=model,
  name={DEVICE\_REMOVED},
  elementname=\cfont{DeviceRemoved},
  kind={event,type},
  description={\glselementname{deviceremoved event} is an \gls{event} that provides the \gls{uuid term} of a device removed from an \gls{mtconnect agent}.},
  facet={\gls{string}}
}


\newglossaryentry{devicechanged event}
{
  type=mtc,
  category=model,
  name={DEVICE\_CHANGED},
  elementname=\cfont{DeviceChanged},
  kind={event,type},
  description={\glselementname{devicechanged event} is an \gls{event} that provides the \gls{uuid term} of the device whose \gls{metadata} has changed.},
  facet={\gls{string}}
}

\newglossaryentry{connectionstatus event}
{
  type=mtc,
  category=model,
  name={CONNECTION\_STATUS},
  elementname=\cfont{ConnectionStatus},
...
\newglossaryentry{established value}
{
  type=mtc,
  category=model,
  name={ESTABLISHED},
...
\newglossaryentry{adaptersoftwareversion event}
{
  type=mtc,
  category=model,
  name={ADAPTER\_SOFTWARE\_VERSION},
  elementname=\cfont{AdapterSoftwareVersion},
  kind={event,type},
  description={The originator's software version of the \gls{adapter}.},
  facet={\gls{string}}
}

\newglossaryentry{adapteruri event}
{
  type=mtc,
  category=model,
  name={ADAPTER\_URI},
  elementname=\cfont{AdapterURI},
  kind={event,type},
  description={The \gls{uri} of the \gls{adapter}.},
  facet={\gls{string}}
}

\newglossaryentry{observationupdaterate sample}
{
  type=mtc,
  category=model,
  name={OBSERVATION\_UPDATE\_RATE},
  elementname=\cfont{ObservationUpdateRate},
  kind={sample,type},
...
\newglossaryentry{assetupdaterate sample}
{
  type=mtc,
  category=model,
  name={ASSET\_UPDATE\_RATE},
  elementname=\cfont{AssetUpdateRate},
  kind={sample,type},
...
\newglossaryentry{countpersecond}
{
  type=mtc,
  category=model,
  name={COUNT/SECOND},
...
\newglossaryentry{mtconnectversion}
{
  type=mtc,
  category=model,
...
\newglossaryentry{dataitemrelationship}
{
  type=mtc,
  category=model,
  name={DataItemRelationship},
  description={A \cfont{Relationship} providing a semantic reference to another \gls{dataitem} described by the \gls{type} property.},
  kind={relationship}
}

\newglossaryentry{specificationrelationship}
{
  type=mtc,
  category=model,
  name={SpecificationRelationship},
  description={A \cfont{Relationship} providing a semantic reference to a \gls{specification} described by the \gls{type} and \gls{idref} property.},
  kind={relationship}
}

\newglossaryentry{attachment type}
{
  type=mtc,
  category=model,
  name={ATTACHMENT},
...
\newglossaryentry{coordinatesystem type}
{
  type=mtc,
  category=model,
...
\newglossaryentry{observation type}
{
  type=mtc,
  category=model,
  name={OBSERVATION},
...
\newglossaryentry{deceleration sample}
{
  type=mtc,
  category=model,
  name={DECELERATION},
  elementname=\cfont{Deceleration},
  description={Negative rate of change of velocity.},
  units=\cfont{\gls{millimeterpersecondsquared}},
  kind={type,sample}
}

\newglossaryentry{angulardeceleration sample}
{
  type=mtc,
  category=model,
  name={ANGULAR\_DECELERATION},
  elementname=\cfont{AngularDeceleration},
  description={Negative rate of change of angular velocity.},
  units=\cfont{\gls{degreepersecondsquared}},
  kind={type,sample}
}

\newglossaryentry{turret}
{
  type=mtc,
  category=model,
  name={turret},
...
\newglossaryentry{automatictoolchanger}
{
  type=mtc,
  category=model,
...
\newglossaryentry{transferpot type}
{
  type=mtc,
  category=model,
  name={TRANSFER\_POT},
...
\newglossaryentry{returnpot type}
{
  type=mtc,
  category=model,
  name={RETURN\_POT},
...
\newglossaryentry{stagingpot type}
{
  type=mtc,
  category=model,
  name={STAGING\_POT},
...
\newglossaryentry{removalpot type}
{
  type=mtc,
  category=model,
  name={REMOVAL\_POT},
...
\newglossaryentry{expiredpot type}
{
  type=mtc,
  category=model,
  name={EXPIRED\_POT},
...
\newglossaryentry{endeffector type}
{
  type=mtc,
  category=model,
  name={END\_EFFECTOR},
...
\newglossaryentry{automatictoolchanger component}
{
  type=mtc,
  category=model,
  name={AutomaticToolChanger},
...
\newglossaryentry{toolmagazine component}
{
  type=mtc,
  category=model,
  name={ToolMagazine},
...
\newglossaryentry{turret component}
{
  type=mtc,
  category=model,
  name={Turret},
...
\newglossaryentry{gangtoolbar component}
{
  type=mtc,
  category=model,
  name={GangToolBar},
...
\newglossaryentry{toolrack component}
{
  type=mtc,
  category=model,
  name={ToolRack},
...
\newglossaryentry{pot composition}
{
  type=mtc,
  category=model,
  name={POT},
...
\newglossaryentry{station composition}
{
  type=mtc,
  category=model,
  name={STATION},
...
\newglossaryentry{transferarm composition}
{
  type=mtc,
  category=model,
  name={TRANSFER\_ARM},
...
\newglossaryentry{transferpot composition}
{
  type=mtc,
  category=model,
  name={TRANSFER\_POT},
...
\newglossaryentry{returnpot composition}
{
  type=mtc,
  category=model,
  name={RETURN\_POT},
...
\newglossaryentry{stagingpot composition}
{
  type=mtc,
  category=model,
  name={STAGING\_POT},
...
\newglossaryentry{removalpot composition}
{
  type=mtc,
  category=model,
  name={REMOVAL\_POT},
...
\newglossaryentry{expiredpot composition}
{
  type=mtc,
  category=model,
  name={EXPIRED\_POT},
...
\newglossaryentry{upperlimit key}
{
  type=mtc,
  category=model,
  name={UPPER\_LIMIT},
...
\newglossaryentry{lowerlimit key}
{
  type=mtc,
  category=model,
  name={LOWER\_LIMIT},
...
\newglossaryentry{upperwarning key}
{
  type=mtc,
  category=model,
  name={UPPER\_WARNING},
...
\newglossaryentry{lowerwarning key}
{
  type=mtc,
  category=model,
  name={LOWER\_WARNING},
...
\newglossaryentry{maximum term}
{
  name={maximum},
  description={A numeric upper constraint.}
}

\newglossaryentry{upper limit term}
{
  name={upper limit},
...
\newglossaryentry{alarm limits term}
{
  name={alarm limits},
  description={A set of limits used to trigger warning or alarm indicators.}
}

\newglossaryentry{controllimit event}
{
  type=mtc,
  category=model,
  name={CONTROL\_LIMIT},
  elementname=\cfont{ControlLimit},
  kind={event,type},
  description={\glsdesc{control limits term}},
  facet={\gls{float}}
}

\newglossaryentry{specificationlimit event}
{
  type=mtc,
  category=model,
  name={SPECIFICATION\_LIMIT},
  elementname=\cfont{SpecificationLimit},
  kind={event,type},
  description={\glsdesc{specification limits term}},
  facet={\gls{float}}
}

\newglossaryentry{alarmlimit event}
{
  type=mtc,
  category=model,
  name={ALARM\_LIMIT},
  elementname=\cfont{AlarmLimit},
  kind={event,type},
  description={\glsdesc{alarm limits term}},
  facet={\gls{float}}
}

\newglossaryentry{originator}
{
  type=mtc,
  category=model,
  name={originator},
...
\newglossaryentry{processspecification}
{
  type=mtc,
  category=model,
...
\newglossaryentry{partoccurrence}
{
  type=mtc,
  category=model,
  name={PartOccurrence},
...
\newglossaryentry{partuniqueid event}
{
  type=mtc,
  category=model,
  name={PART\_UNIQUE\_ID},
  elementname=\cfont{PartUniqueId},
  kind={event,type},
...
\newglossaryentry{serialnumber subtype}
{
  type= mtc,
  category=model,
  name={SERIAL\_NUMBER},
...
\newglossaryentry{rawmaterial subtype}
{
  type= mtc,
  category=model,
  name={RAW\_MATERIAL},
...
\newglossaryentry{partkindid event}
{
  type=mtc,
  category=model,
  name={PART\_KIND\_ID},
  elementname=\cfont{PartKindId},
  kind={event,type},
...
\newglossaryentry{partnumber subtype}
{
  type= mtc,
  category=model,
  name={PART\_NUMBER},
...
\newglossaryentry{partfamily subtype}
{
  type= mtc,
  category=model,
  name={PART\_FAMILY},
...
\newglossaryentry{partname subtype}
{
  type= mtc,
  category=model,
  name={PART\_NAME},
...
\newglossaryentry{partgroupid event}
{
  type=mtc,
  category=model,
  name={PART\_GROUP\_ID},
  elementname=\cfont{PartGroupId},
  kind={event,type},
...
\newglossaryentry{heattreat subtype}
{
  type= mtc,
  category=model,
  name={HEAT\_TREAT},
...
\newglossaryentry{processstate event}
{
  type=mtc,
  category=model,
  name={PROCESS\_STATE},
  elementname=\cfont{ProcessState},
  kind={event,type},
...
\newglossaryentry{inprocess value}
{
  type=mtc,
  category=model,
  name={IN\_PROCESS},
...
\newglossaryentry{processkindid event}
{
  type=mtc,
  category=model,
  name={PROCESS\_KIND\_ID},
  elementname=\cfont{ProcessKindId},
  kind={event,type},
...
\newglossaryentry{processname subtype}
{
  type= mtc,
  category=model,
  name={PROCESS\_NAME},
...
\newglossaryentry{isostepexecutable subtype}
{
  type= mtc,
  category=model,
...
\newglossaryentry{processaggregateid event}
{
  type=mtc,
  category=model,
  name={PROCESS\_AGGREGATE\_ID},
  elementname=\cfont{ProcessAggregateId},
  kind={event,type},
...
\newglossaryentry{processstep subtype}
{
  type= mtc,
  category=model,
  name={PROCESS\_STEP},
...
\newglossaryentry{processplan subtype}
{
  type= mtc,
  category=model,
  name={PROCESS\_PLAN},
...
\newglossaryentry{ordernumber subtype}
{
  type= mtc,
  category=model,
  name={ORDER\_NUMBER},
...
\newglossaryentry{processoccurrenceid event}
{
  type=mtc,
  category=model,
  name={PROCESS\_OCCURRENCE\_ID},
  elementname=\cfont{ProcessOccurrenceId},
  kind={event,type},
  description={An identifier of a process being executed by the device.},
  facet={\gls{string}}
}

\newglossaryentry{partstatus event}
{
  type=mtc,
  category=model,
  name={PART\_STATUS},
  elementname=\cfont{PartStatus},
  kind={event,type},
...
\newglossaryentry{processoccurrence}
{
  type=mtc,
  category=model,
...
\newglossaryentry{motion configuration}
{
  type=mtc,
  category=model,
  name={Motion},
...
\newglossaryentry{axis configuration}
{
  type=mtc,
  category=model,
  name={Axis},
...
\newglossaryentry{revolute motion}
{
  type=mtc,
  category=model,
  name={REVOLUTE},
...
\newglossaryentry{continuous motion}
{
  type=mtc,
  category=model,
  name={CONTINUOUS},
...
\newglossaryentry{prismatic motion}
{
  type=mtc,
  category=model,
  name={PRISMATIC},
...
\newglossaryentry{direct actuation}
{
  type=mtc,
  category=model,
  name={DIRECT},
...
\newglossaryentry{virtual actuation}
{
  type=mtc,
  category=model,
  name={VIRTUAL},
...
\newglossaryentry{solidmodel configuration}
{
  type=mtc,
  category=model,
  name={SolidModel},
...
\newglossaryentry{step mediatype}
{
  type=mtc,
  category=model,
  name={STEP},
...
\newglossaryentry{gdml mediatype}
{
  type=mtc,
  category=model,
  name={GDML},
...
\newglossaryentry{collada mediatype}
{
  type=mtc,
  category=model,
  name={COLLADA},
...
\newglossaryentry{iges mediatype}
{
  type=mtc,
  category=model,
  name={IGES},
...
\newglossaryentry{acis mediatype}
{
  type=mtc,
  category=model,
  name={ACIS},
...
\newglossaryentry{applicationcategory}
{
  type=mtc,
  category=model,
...
\newglossaryentry{applicationtype}
{
  type=mtc,
  category=model,
...
\newglossaryentry{inspection type}
{
  type=mtc,
  category=model,
  name={INSPECTION},
...
\newglossaryentry{documentation type}
{
  type=mtc,
  category=model,
  name={DOCUMENTATION},
...
\newglossaryentry{instructions type}
{
  type=mtc,
  category=model,
  name={INSTRUCTIONS},
...
\newglossaryentry{productionprogram type}
{
  type=mtc,
  category=model,
...
\newglossaryentry{creationtime element}
{
  type=mtc,
  category=model,
  name={CreationTime},
...
\newglossaryentry{modificationtime}
{
  type=mtc,
  category=model,
...
\newglossaryentry{experimental value}
{
  type=mtc,
  category=model,
  name={EXPERIMENTAL},
...
\newglossaryentry{revision value}
{
  type=mtc,
  category=model,
  name={REVISION},
  kind={enum},
  description={The content is modified from \cfont{PRODUCTION} or \cfont{EXPERIMENTAL}.}
}

\newglossaryentry{fileproperty}
{
  type=mtc,
  category=model,
  name={FileProperty},
  description={A key-value pair providing additional metadata about a \cfont{File}.}
}

\newglossaryentry{filelocation}
{
  type=mtc,
  category=model,
  name={FileLocation},
...
\newglossaryentry{fileproperties}
{
  type=mtc,
  category=model,
  name={FileProperties},
  description={\cfont{FileProperties} \glspl{organize} one or more \cfont{FileProperty} entities for \cfont{File}s.}
}

\newglossaryentry{filecomments}
{
  type=mtc,
  category=model,
  name={FileComments},
  description={\cfont{FileComments} \glspl{organize} one or more \cfont{FileComment} entities for \cfont{File}s.}
}

\newglossaryentry{destinations}
{
  type=mtc,
  category=model,
  name={Destinations},
  description={\cfont{Destinations} \glspl{organize} one or more \cfont{Destination} elements.}
}

\newglossaryentry{controllimits specification}
{
  type=mtc,
  category=model,
  name={ControlLimits},
...
\newglossaryentry{specificationlimits specification}
{
  type=mtc,
  category=model,
...
\newglossaryentry{alarmlimits specification}
{
  type=mtc,
  category=model,
  name={AlarmLimits},
