...
{
	AnXML element used to organize \gls{lower level} child elements that share a common relationship to the \gls{parent element}.
...
\newglossaryentry{endeffector}
{
  ...
  category=model,
  name={EndEffector},
  description={\gls{endeffector} is an XML container that represents the information for those functions that form the last link segment of a robot. It is the part of the robot that interacts with the manufacturing process.},
...
\newglossaryentry{xlink:href}
{
  type=mtc,
  category=model,
  name={xlink:href},
  description={A URL identifying the \gls{agent} associated with the piece of equipment associated with this piece of equipment and the UUID identifying that specific piece of equipment.
  \newline \gls{xlink:href} is an optional attribute.},
  kind={attribute}
}
...
\newglossaryentry{entry}
{
  ...
  category=model,
  name={Entry},
  description={A XML element representing a \gls{key-value pair} published as part of a \gls{data set}.},
  kind={element}
}
