...
package :Component, 'Top Level Components Package' do
  ...
  type :Controller, 'A controller', :Component do
    standards :OMAC => 'CNC'
  end

  type :Power, 'A power measuring component', :Component
  type :Sensor, 'A sensor, this is not abstract to allow for easy extensibility.', :Component
